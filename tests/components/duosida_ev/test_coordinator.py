...
from homeassistant.components.duosida_ev.const import MAX_RETRY_ATTEMPTS
from homeassistant.components.duosida_ev.coordinator import DuosidaDataUpdateCoordinator
...
) -> Generator[DuosidaDataUpdateCoordinator]:
...
async def test_coordinator_update_success(
    ...
    # Use _async_update_data directly instead of async_config_entry_first_refresh
